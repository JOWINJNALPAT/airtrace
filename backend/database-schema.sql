...
CREATE TABLE IF NOT EXISTS staff (
    ...
    role ENUM('Admin', 'Desk') NOT NULL DEFAULT 'Desk',
...
CREATE TABLE IF NOT EXISTS location (
    ...
    zone_type ENUM('Gate', 'Duty', 'Free') NOT NULL,
...
CREATE TABLE IF NOT EXISTS item (
    ...
    status ENUM('Lost', 'Found', 'Returned', 'Verified') NOT NULL DEFAULT 'Found',
...
CREATE TABLE IF NOT EXISTS claim (
    ...
    UNIQUE KEY unique_claim (passenger_id, item_id)
);
